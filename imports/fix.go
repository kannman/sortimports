...
import (
	...
	"github.com/kannman/sortimports/internal/fastwalk"
...
func samePartyPrefixes() []string {
	if SamePartyPrefix != "" {
		return strings.Split(SamePartyPrefix, ",")
	}
	return nil
}
...
var importToGroup = []func(importPath string) (num int, ok bool){
	...
	func(importPath string) (num int, ok bool) {
		for _, p := range samePartyPrefixes() {
			if strings.HasPrefix(importPath, p) || strings.TrimSuffix(p, "/") == importPath {
				return 2, true
			}
		}
