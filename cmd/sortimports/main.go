...
import (
	...
	"github.com/kannman/sortimports/imports"
)
...
func init() {
	...
	flag.StringVar(&imports.LocalPrefix, "local", "", "put imports beginning with this string before 3rd-party packages; comma-separated list")
	flag.StringVar(&imports.SamePartyPrefix, "sameparty", "", "put imports beginning with this string before 3rd-party packages but after local packages; comma-separated list")
}
